...
if __name__ == "__main__":
    ...
    #METRICS
    metrics = [Metric_Total_Reward, Metric_Epsilon, Metric_Actor_Loss, Metric_Critic_Loss, Metric_Critic_Value, Metric_Critic_Value_Unnormalized]
    #ACTOR PI
    actor = nn.Sequential(
    ...
    #RUN
    run(agent, env, episodes=10000000, wandb_cb = True, plt_cb=False, video_cb = True)
